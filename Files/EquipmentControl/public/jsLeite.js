...
var milkSpill = new TimelineMax()
    .to('#milk-spill--large', 10, { scale: 1.25, transformOrigin: "right", ease: Power1.easeInOut });

// Face Hover
var face = new TimelineMax({ yoyo: true, repeat: -1 })
    .to('#milk-face', 1, { yPercent: -15, ease: Power1.easeInOut });
...
var tlMouth = new TimelineMax({ repeatDelay: 1, repeat: -1, yoyo: true });
